        ...
        <div className="row align-items-center">
          ...
          <div className="col-xl-5 col-lg-12 order-0 order-xl-1">
            <div className="tp-about-2-content">
              ...
              <p className="mb-30">
                At The-X-Media, we transform businesses through innovative e-commerce solutions and custom mobile applications. Our expert team delivers scalable technology that drives growth and enhances customer engagement.
              </p>
              <p className="mb-0">
                We specialize in creating digital experiences that
                  connect brands with their customers effectively.
              </p>
            </div>
          </div>
