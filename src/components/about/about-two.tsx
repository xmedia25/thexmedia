          ...
          <div className="col-xl-10 col-md-10">
            <div className="tp-about-4-title-box tp_fade_bottom">
              <h4 className="tp-about-4-title">
                Find out more about the team behind the best and fastest The-X-Media
              ...
              <div className="row">
                <div className="col-xl-6 col-lg-6">
                  <div className="tp-about-4-content item-1 tp_fade_bottom">
                    <p>
                      Empowering businesses with cutting-edge e-commerce and mobile solutions.
                        Our innovative approach delivers exceptional results that drive
